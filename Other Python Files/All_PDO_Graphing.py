...
def graph_airport(airport_data):
    ...
    if "Merged_Files_Tables" in airport_data:
        plt.savefig("Airport_Graphs_PDO/Airport_Graphs_PDO_M/" + airport_data[airport_data.index("/")+1:airport_data.index(".")]+" Graph.pdf",  dpi=300, format='pdf', bbox_inches='tight')
    if "Older_Files_Tables" in airport_data:
        plt.savefig("Airport_Graphs_PDO/Airport_Graphs_PDO_O/" + airport_data[airport_data.index("/")+1:airport_data.index(".")]+" Graph.pdf",  dpi=300, format='pdf', bbox_inches='tight')
    if "Airport_Data_from_Sam_Tables" in airport_data:
        plt.savefig("Airport_Graphs_PDO/Airport_Graphs_PDO_S/" + airport_data[airport_data.index("/")+1:airport_data.index(".")]+" Graph.pdf",  dpi=300, format='pdf', bbox_inches='tight')
