...
def graph_airport(airport_data):
    ...
    plt.savefig("Twenty_Two_Graphs/Graphs/" + airport_data[airport_data.index("/")+1:airport_data.index(".")]+"_Graph.pdf",  dpi=300, format='pdf', bbox_inches='tight')
    ...
    plt.savefig("Twenty_Two_Graphs/PDO_Graphs/" + airport_data[airport_data.index("/")+1:airport_data.index(".")]+"_PDO_Graph.pdf",  dpi=300, format='pdf', bbox_inches='tight')
...
if not os.path.exists("Twenty_Two_Graphs/PDO_Graphs/"):
    os.makedirs("Twenty_Two_Graphs/PDO_Graphs/")
if not os.path.exists("Twenty_Two_Graphs/Graphs/"):
    os.makedirs("Twenty_Two_Graphs/Graphs/")
for file in os.listdir('Twenty_Two_Tables'):
    airport_name = file[:file.index(".")]
    twenty_airport_CLC_data[airport_name] = graph_airport('Twenty_Two_Tables/' + file)
    check += 1
    print("Graphed " + str(check) + " airport datasets")
twenty_airport_CLC_data.to_csv("Twenty_Two_Aiport_Data_1-24.csv")
print("Done")
